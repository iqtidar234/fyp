  ...
  ({
    ...
    return (
      <div className="overflow-none relative flex-1 bg-white dark:bg-[#343541]">
        <>
          <div className="max-h-full overflow-x-hidden" ref={chatContainerRef}>
            ...
            conversation.messages.length === 0 ? (
              ...
              <>
                <div className="flex  justify-center border border-b-neutral-300 bg-[#f3f3f3]  py-2 text-sm text-[#333333] dark:border-none dark:bg-[#444654] dark:text-neutral-200">
                  Explore Divine Guidance: Seek Authentic Answers Directly from
                  the Quran with 'Connect with Islam
                </div>
