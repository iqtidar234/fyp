...
export const Sidebar: FC<Props> = ({
  ...
  return (
    <aside
      className={`bg-custom fixed top-0 bottom-0 z-50 flex h-full w-[260px] flex-none flex-col space-y-2 p-2 transition-all sm:relative sm:top-0`}
    >
      <header className="flex items-center">
        <button
          className="flex w-[190px] flex-shrink-0 cursor-pointer select-none items-center gap-3 rounded-md border border-white p-3 text-[12.5px] leading-3 text-white transition-colors duration-200 hover:bg-gray-500/10"
          onClick={() => {
            onNewConversation();
            setSearchTerm('');
          }}
        ...
        <button
          className="ml-2 flex flex-shrink-0 cursor-pointer items-center gap-3 rounded-md border border-white p-3 text-[12.5px] leading-3 text-white transition-colors duration-200 hover:bg-gray-500/10"
