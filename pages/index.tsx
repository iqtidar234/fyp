...
const Home: React.FC<HomeProps> = ({ serverSideApiKeyIsSet }) => {
  ...
  const [showKeyConfigurationAlert, setShowKeyConfigurationAlert] =
    useState(false);
  ...
  const handleNewConversation = () => {
    ...
    const newConversation: Conversation = {
      ...
      folderId: 0,
      index: {
        indexName: '33a6884a-8e28-4fa5-8c71-38b9870e8f13',
        indexType: 'pdf',
      },
    };
  ...
  return (
    <>
      <Head>
        <title>Connect With Islam</title>
      ...
      {showKeyConfigurationAlert && (
        <KeySettingsAlertDialog
          onCancellation={handleShowKeyConfigurationAlertCancel}
